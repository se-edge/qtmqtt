...
Q_MQTT_EXPORT qmqtthash_t qHash(const QMqttTopicName &name, qmqtthash_t seed = 0) Q_DECL_NOTHROW;
...
public:
    ...
    friend Q_MQTT_EXPORT bool operator<(const QMqttTopicName &lhs, const QMqttTopicName &rhs) Q_DECL_NOTHROW;
    friend Q_MQTT_EXPORT qmqtthash_t qHash(const QMqttTopicName &name, qmqtthash_t seed) Q_DECL_NOTHROW;
