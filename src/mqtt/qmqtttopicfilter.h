...
Q_MQTT_EXPORT qmqtthash_t qHash(const QMqttTopicFilter &name, qmqtthash_t seed = 0) Q_DECL_NOTHROW;
...
public:
    ...
    friend Q_MQTT_EXPORT bool operator<(const QMqttTopicFilter &lhs, const QMqttTopicFilter &rhs) Q_DECL_NOTHROW;
    friend Q_MQTT_EXPORT qmqtthash_t qHash(const QMqttTopicFilter &filter, qmqtthash_t seed) Q_DECL_NOTHROW;
